        ...
        <section class="section-padding">
            <div class="container">
                    <div class="text-center mb-80">
                        <h2 class="text-uppercase text font-30 mb-30"><b>Inovasi Sirup Empon Empon</b></h2>
                    </div>
                  <div class="row">
                        ...
                        <div class="panel-body">
                          <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="tab-25">
                                <p> Berangkat dari kebutuhan teman untuk dibuatkan empon-empon untuk meningkatkan imun tubuh guna pencegahan terkena virus covid-19, maka sirup empon inipun tercipta. Ternyata responnya positif dan banyak permintaan. Sirup empon ini menjadi jawaban yang tepat bagi calon wirausaha, karena jamu empon meski sudah lama dikenal banyak orang namun momen pandemi ini menjadi naik lagi tren nya karena sebagai supplement herbal untuk menjaga imunitas tubuh. Karena dipercaya covid-19 akan memberikan efek yang besar pada orang yang mempunyai imun rendah. Selain dari pasarnya yang terbuka lebar, sirup empon ini sebenarnya membutuhkan bahan yang relatif mudah di dapat dan melimpah di Indonesia. Banyak manfaat yang mampu diberikan oleh sirup empon ini, pertama dari segi material dapat memberikan peningkatan ekonomi rumah tangga maupun daerah. Kedua untuk dapat ikut membantu program pemerintahan terkait penanggulangan penyebaran virus covid-19. Ketiga dapat memberikan alternatif bagi para milenial yang kurang menyukai jamu yang pahit, serta anak-anakpun suka dengan rasa manisnya. Keempat yaitu dapat menjadi produk kebanggan daerah maupun Indonesia nantinya.
                                </p>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="tab-26">
                                <p> 1. Rasa yang nikmat tanpa menghilangkan khasiat dari empon (untuk empon serbuk maupun yang dikeringkan khasiat berkurang) </br>
                                    2. Standar produksi yang ketat sehingga rasa tetap konsisten </br>
                                    3. Packaging sachet sekali minum (bisa seduh ataupun langsung minum) membuat mudah dibawa dan praktis. </br>
                                    4. Tidak menggunakan bahan pengawet </br>
                                    5. Mengandung banyak nutrisi yang baik bagi perawatan kesehatan tubuh </br>
                                    6. Rasa manis, segar dan menghangatkan tubuh </br>
                                    7. Dapat meningkatkan energi dan stamina tubuh.</br>                                   
                                    </p>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="tab-27">
                                <p> No. Telepon	: +6287732569324</p>
                            </div>
                          </div>
                        </div>
                  </div><!-- /.col-md-12 -->
                ...
                <div class="gallery-thumb fa-pull-left">
                    <ul class="slides">
                    <li data-thumb="assets/img/blog/sirup (1).jpg">
                        <img src="assets/img/blog/sirup (1).jpg" alt="image">
                    </li>
                    <li data-thumb="assets/img/blog/sirup (2).jpg">
                        <img src="assets/img/blog/sirup (2).jpg" alt="image">
                    </li>
                    <li data-thumb="assets/img/blog/sirup (3).jpg">
                        <img src="assets/img/blog/sirup (3).jpg" alt="image">
                    </li>
                    </ul>
                </div><!-- /.gallery-thumb -->
                </div><!-- /.col-md-5 -->
