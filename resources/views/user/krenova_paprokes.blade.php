        ...
        <section class="section-padding">
            <div class="container">
                    <div class="text-center mb-80">
                        <h2 class="text-uppercase text font-30 mb-30"><b>Inovasi Paprokes</b></h2>
                    </div>
                  <div class="row">
                        ...
                        <div class="panel-body">
                          <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="tab-25">
                                <p>  Teknologi ini dapat  mendeteksi apakah orang yang akan masuk memakai masker atau tidak memakai masker, memastikan seseorang sudah menggunakan hand sanitizer  sebelum masuk ke lingkungan sekolah, mampu mendeteksi suhu normal dan suhu tinggi, perekaman data suhu yang dapat dimonitoring menggunakan website untuk mempermudah tracing jika terdapat seseorang yang menunjukkan gejala awal terinfeksi virus COVID-19 dengan indikasi suhu di atas normal. Ujicoba yang sudah dilakukan mulai tanggal 18 April sampai dengan 21 April 2021 dengan jumlah pengguna 11 orang, dan diuji coba sebanyak 619 kali. Mampu mendeteksi masker, dan suhu dengan jumlah suhu normal sebanyak 600 kali, dan suhu tidak normal 19 kali.
                                </p>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="tab-26">
                                <p> 1. Dilengkapi hand sanitizer otomatis. </br>
                                    2. Dilengkapi dengan sistem AI (Artificial Intelligence) dan IoT (Internet of Things) yang datanya dapat dipantau melalui website untuk keperluan tracking jika ada seseorang yang terindikasi COVID-19. </br>
                                    3. Perekaman data yang dapat dimonitoring lewat website. </br>
                                    4. Dibandingkan dengan temuan sejenis sebelumnya dimana tidak dilengkapi </br> 
                                    5. Hand sanitizer otomatis. </br>
                                    6. Perekaman data yang dapat dimonitor melalui website.     </br>                              
                                    </p>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="tab-27">
                                <p> No. Telepon	: +6285225956368</p>
                            </div>
                          </div>
                        </div>
                  </div><!-- /.col-md-12 -->
                ...
                <div class="gallery-thumb fa-pull-left">
                    <ul class="slides">
                    <li data-thumb="assets/img/blog/paprokes (1).png">
                        <img src="assets/img/blog/paprokes (1).png" alt="image">
                    </li>
                    <li data-thumb="assets/img/blog/paprokes (2).png">
                        <img src="assets/img/blog/paprokes (2).png" alt="image">
                    </li>
                    <li data-thumb="assets/img/blog/paprokes (3).png">
                        <img src="assets/img/blog/paprokes (3).png" alt="image">
                    </li>
                    </ul>
                </div><!-- /.gallery-thumb -->
                </div><!-- /.col-md-5 -->
