        ...
        <section class="section-padding">
            <div class="container">
                    <div class="text-center mb-80">
                        <h2 class="text-uppercase text font-30 mb-30"><b>Oppa Daego</b></h2>
                    </div>
                  <div class="row">
                ...
                <div class="gallery-thumb fa-pull-left">
                    <ul class="slides">
                    <li data-thumb="assets/img/blog/oppa (1).jpeg">
                        <img src="assets/img/blog/oppa (1).jpeg" alt="image">
                    </li>
                    <li data-thumb="assets/img/blog/oppa (2).jpeg">
                        <img src="assets/img/blog/oppa (2).jpeg" alt="image">
                    </li>
                    <li data-thumb="assets/img/blog/oppa (3).jpeg">
                        <img src="assets/img/blog/oppa (3).jpeg" alt="image">
                    </li>
                    </ul>
                </div><!-- /.gallery-thumb -->
                </div><!-- /.col-md-5 -->
