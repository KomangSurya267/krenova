...
<body class="">
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="../index.html">
        <img src="{{ asset('/') }}img/brand/krenova.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{ asset('/') }}img/brand/dashboard.png">
              </span>
            </div>
          </a>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        <!-- Collapse header -->
          ...
          <li class="nav-item  active ">
            <a class="nav-link  active " href="{{ url('layout/home') }}" class="nav-link">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link  active " href="{{route('admin.user')}}" class="nav-link">
        ...
        <ul class="navbar-nav">
          <li class="nav-item  active ">
            <a class="nav-link  active " href="{{route('admin.index')}}" class="nav-link">
  ...
  <div class="main-content">
    ...
    background-image: url({{ asset('/') }}img/brand/dashboard.png); background-size: center-top; background-position: center top;">
      <!-- Mask -->
...
<body class="">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" 
                        placeholder="Masukkan Nama Lengkap" name="name" id="name" type="text">
                      </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="input-address">Username</label>
  ...
  <!--   Optional JS   -->
  <!--   Argon JS   -->
  <script src="{{ asset('/') }}argon-dashboard.min.js?v=1.1.2"></script>
